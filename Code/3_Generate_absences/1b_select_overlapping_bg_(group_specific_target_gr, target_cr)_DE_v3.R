...
lisi.dat.s <- list()
lisi.dat.s[[1]] <- read.csv('/net/kryo/work/deriksson/notion/3_Match_up/Output_2/Obs_gridded_diazo_pres_abs.csv')
lisi.dat.s[[2]] <- read.csv('/net/kryo/work/deriksson/notion/3_Match_up/Output_2/Obs_gridded_diazo_nifHcounts_abs.csv')
...
lisi.dat.raw <- list()
lisi.dat.raw[[1]] <- read.csv('/net/kryo/work/deriksson/notion/3_Match_up/Output_2/Obs_raw_diazo_pres_abs.csv')
lisi.dat.raw[[2]] <- read.csv('/net/kryo/work/deriksson/notion/3_Match_up/Output_2/Obs_raw_diazo_nifHcounts_abs.csv')
...
# Specify parameters to stratify the samples environment: ** ADJUST IN CASE **
...
for(d in 1:4){
  ...
  # Save list
	fln <- paste0("./4_Generate_absences/Output_1/",d+2," ",nms.sets[d],"(",vec.strat[1],"_",vec.strat[2],").RData")
...
# nifH counts --> NOT SMAE RESULT AS DAMIANO for some species
